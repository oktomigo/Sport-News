            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Jadwal Badminton</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <div class="mb-4">
                            <h6 class="text-uppercase font-weight-bold">Pengumuman</h6>
                            <p class="mb-4">Untuk informasi mengenai Jadwal Badminton TerUpdate!! silahkan klik link Jadwal Badminton <a href="https://www.bola.net/bulutangkis/jangan-lupa-dukung-indonesia-inilah-jadwal-lengkap-turnamen-bulu-tangkis-bwf-2023-562e5f.html">Klik Disini</a>.</p>
