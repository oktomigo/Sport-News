            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Jadwal Sepak Bola</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <div class="mb-4">
                            <h6 class="text-uppercase font-weight-bold">Pengumuman</h6>
                            <p class="mb-4">Untuk informasi mengenai Jadwal Sepak Bola TerUpdate!! silahkan klik link Jadwal Sepak Bola <a href="https://www.bola.net/jadwal-pertandingan/">Klik Disini</a>.</p>
